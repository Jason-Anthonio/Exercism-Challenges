...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    total_foreign_currency = exchange_money(budget, exchange_rate + (exchange_rate * spread/100))
    
    return get_value_of_bills(denomination, get_number_of_bills(total_foreign_currency, denomination))
